...
def forward(apps, schema_editor):
    ...
    # Apply the fixtures
    call_command('loaddata', 'partnership/fixtures/funding_source.json')
    call_command('loaddata', 'partnership/fixtures/funding_program.json')
    call_command('loaddata', 'partnership/fixtures/funding_type.json')

    # Create the default funding program
    default_program = FundingProgram.objects.create(
        name="Néant",
        source_id=12,  # This is the source "Néant" from fixture
    )
