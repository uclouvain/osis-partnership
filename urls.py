...
urlpatterns = [
    ...
    path('<int:partnership_pk>/contacts/', include(([
                                                path('new/', PartnershipContactCreateView.as_view(),
                                                             name="create"),
                                                path('<int:pk>/update/', PartnershipContactUpdateView.as_view(),
                                                             name="update"),
                                                path('<int:pk>/delete/', PartnershipContactDeleteView.as_view(),
                                                             name="delete"),
    ...
    path('<int:partnership_pk>/medias/', include(([
                                                    ...
                                                    path('<int:pk>/update/', PartnershipMediaUpdateView.as_view(),
                                                           name="update"),
                                                    path('<int:pk>/delete/', PartnershipMediaDeleteView.as_view(),
                                                           name="delete"),
                                                    path('<int:pk>/download/', PartnershipMediaDownloadView.as_view(),
                                                           name="download"),
                                                  ], 'partnerships'), namespace='medias')),

    path('<int:partnership_pk>/agreements/', include(([
                                                          path('<int:pk>/delete/',
                                                               PartnershipAgreementDeleteView.as_view(), name="delete"),
                                                          path('<int:pk>/update/',
                                                               PartnershipAgreementUpdateView.as_view(), name="update"),
                                                          path('<int:pk>/download_media/',
                                                               PartnershipAgreementMediaDownloadView.as_view(),
                                                               name="download_media"),
                                                          path('new/', PartnershipAgreementCreateView.as_view(),
                                                               name="create"),
    ...
    path('partners/', include(([
                                   ...
                                   path('<int:partner_pk>/medias/', include(([
                                                                                 path('new/',
                                                                                      PartnerMediaCreateView.as_view(),
                                                                                      name="create"),
                                                                                 path('<int:pk>/update/',
                                                                                      PartnerMediaUpdateView.as_view(),
                                                                                      name="update"),
                                                                                 path('<int:pk>/delete/',
                                                                                      PartnerMediaDeleteView.as_view(),
                                                                                      name="delete"),
                                                                                 path('<int:pk>/download/',
                                                                                    PartnerMediaDownloadView.as_view(),
                                                                                    name="download"),
                                                                             ], 'partnerships'), namespace='medias')),
                                   path('<int:partner_pk>/entities/', include(([
                                                                                   path('new/',
                                                                                    PartnerEntityCreateView.as_view(),
                                                                                    name="create"),
                                                                                   path('<int:pk>/update/',
                                                                                    PartnerEntityUpdateView.as_view(),
                                                                                    name="update"),
                                                                                   path('<int:pk>/delete/',
                                                                                    PartnerEntityDeleteView.as_view(),
                                                                                    name="delete"),
                                                                               ], 'partnerships'),
                                       namespace='entities')),
    ...
    path('ucl_management_entities/', include(([
                                                  ...
                                                  path('create/', UCLManagementEntityCreateView.as_view(),
                                                       name="create"),
                                                  path('<int:pk>/edit/', UCLManagementEntityUpdateView.as_view(),
                                                       name="update"),
                                                  path('<int:pk>/delete/', UCLManagementEntityDeleteView.as_view(),
                                                       name="delete"),
    ...
    path('financings/', include(([
                                     ...
                                     re_path(r'^(?:(?P<year>\d{4})/)?export/$', FinancingExportView.as_view(),
                                             name='export'),
                                     ...
                                     path('delete/<funding:model>/<int:pk>', FundingDeleteView.as_view(),
                                          name='delete'),
    ...
    path('autocomplete/', include(([
                                       ...
                                       path('reference-partner-entity/',
                                            PartnerEntityReferenceAutocompleteView.as_view(),
                                            name='reference_partner_entity'),
                                       path('faculty_entity/', FacultyEntityAutocompleteView.as_view(),
                                            name='faculty_entity'),
                                       ...
                                       path('funding_program/', FundingProgramAutocompleteView.as_view(),
                                            name='funding_program'),
                                       path('funding_type/', FundingTypeAutocompleteView.as_view(),
                                            name='funding_type'),
