...
urlpatterns = [
    ...
    path('<int:partnership_pk>/agreements/',
         include(([
                      ...
                      path('<int:pk>/download_media/', PartnershipAgreementMediaDownloadView.as_view(),
                           name="download_media"),
    ...
    path('partners/',
         include(([
                      ...
                      path('<int:partner_pk>/medias/',
                           include(([
                                        path('new/', PartnerMediaCreateView.as_view(), name="create"),
                                        path('<int:pk>/update/', PartnerMediaUpdateView.as_view(),
                                             name="update"),
                                        path('<int:pk>/delete/', PartnerMediaDeleteView.as_view(),
                                             name="delete"),
                                        path('<int:pk>/download/', PartnerMediaDownloadView.as_view(),
                                             name="download"),
                                    ], 'partnerships'), namespace='medias')),
                      path('<int:partner_pk>/entities/',
                           include(([
                                        path('new/', PartnerEntityCreateView.as_view(), name="create"),
                                        path('<int:pk>/update/', PartnerEntityUpdateView.as_view(),
                                             name="update"),
                                        path('<int:pk>/delete/', PartnerEntityDeleteView.as_view(),
                                             name="delete"),
                                    ], 'partnerships'),namespace='entities')),
                      path('new/', PartnerCreateView.as_view(), name="create"),
                  ], 'partnerships'), namespace='partners')),
    path('ucl_management_entities/',
         include(([
    ...
    path('autocomplete/',
         include(([
                      ...
                      path('reference-partner-entity/', PartnerEntityReferenceAutocompleteView.as_view(),
                      ...
                      path('partnership_year_entities/',PartnershipYearEntitiesAutocompleteView.as_view(),
                           name='partnership_year_entities',),
                      path('partnership_year_offers/',PartnershipYearOffersAutocompleteView.as_view(),
                           name='partnership_year_offers',),
                    # Partnerships filter
                      path('partner-entity-partnerships-filter/',
                           PartnerEntityAutocompletePartnershipsFilterView.as_view(),
                           name='partner_entity_partnerships_filter',),
                      path( 'ucl_entity_filter/',
                            UclUniversityAutocompleteFilterView.as_view(),
                            name='ucl_entity_filter',),
                      path('years_entity_filter/',
