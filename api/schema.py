...
class PartnershipSchemaGenerator(SchemaGenerator):
    ...
    def get_schema(self, *args, **kwargs):
        ...
        schema["info"]["version"] = PARTNERSHIP_SDK_VERSION
        schema["info"]["title"] = "Partnership API"
        schema["info"]["description"] = "This API delivers data for the Partnership project."
        schema["info"]["contact"] = {
            "name": "UCLouvain - OSIS",
